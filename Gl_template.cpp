...
void szesciokat(void)
{
	double x, y, z = 80.0, angle, pi = 3.141;
	glBegin(GL_TRIANGLE_FAN);
	glColor3d(1, 0, 0);
	glVertex3d(0, 0, 0);
	for (angle = 0.0; angle <= 2 * pi; angle += pi / 3.0)
	{
		x = 50.0*sin(angle);
		y = 50.0*cos(angle);
		glVertex3d(x, y, 0);
...
void szescian()
{
	glBegin(GL_QUADS);
	glColor3d(1, 0, 0);
	glVertex3d(20, 20, 20);  //przod
	glVertex3d(-20, 20, 20);
	glVertex3d(-20, -20, 20);
	glVertex3d(20, -20, 20);

	glColor3d(0, 1, 0);
	glVertex3d(20, 20, 20);//prawy bok
	glVertex3d(20, -20, 20);
	glVertex3d(20, -20, -20);
	glVertex3d(20, 20, -20);

	glColor3d(0, 0, 1);
	glVertex3d(20, 20, -20);//ty≥
	glVertex3d(20, -20, -20);
	glVertex3d(-20, -20, -20);
	glVertex3d(-20, 20, -20);

	glColor3d(0.5, 0.5, 0);
	glVertex3d(-20, 20, -20);//lewy bok
	glVertex3d(-20, -20, -20);
	glVertex3d(-20, -20, 20);
	glVertex3d(-20, 20, 20);

	glColor3d(0.5, 0, 0.5);
	glVertex3d(-20, 20, 20);//gora
	glVertex3d(20, 20, 20);
	glVertex3d(20, 20, -20);
	glVertex3d(-20, 20, -20);

	glColor3d(0.5, 0, 1);
	glVertex3d(-20, -20, -20);//dol
	glVertex3d(20, -20, -20);
	glVertex3d(20, -20, 20);
	glVertex3d(-20, -20, 20);
	glEnd();
...
void walec(double r, double h)
{
	...
	glColor3d(0, 1, 0);
	glVertex3d(0, 0, 0);
	for (alpha = 0.0; alpha <= 2 * pi; alpha += pi / 8.0)//podstawa
	{
		x = r * sin(alpha);
		y = r * cos(alpha);
		glVertex3d(x, y, 0);
	...
	glColor3d(0, 0, 1);
	glVertex3d(0, 0, h);
	for (alpha = 0; alpha >= -2 * pi; alpha -= pi / 8.0)//podstawa
	{
		x = r * sin(alpha);
		y = r * cos(alpha);
		glVertex3d(x, y, h);
...
{
	double x, y, alpha, pi = 3.141;
	glBegin(GL_TRIANGLE_FAN);//polowa podstawy
	glColor3d(0, 0.5, 0);
	glVertex3d(0, 0, 0);
	for (alpha = pi; alpha <= 2 * pi; alpha += pi / 8.0)//podstawa
	{
		x = r1 * sin(alpha);
		y = r1 * cos(alpha);
		glVertex3d(x, y, 0);
	...
	glColor3d(0, 0, 1);
	glVertex3d(0, 0, h);
	for (alpha = 0; alpha >= -pi; alpha -= pi / 8.0)//podstawa
	{
		x = r1 * sin(alpha);
		y = r1 * cos(alpha);
		glVertex3d(x, y, h);
	...
	glBegin(GL_TRIANGLE_FAN);//polowa podstawy prawe strony
	glColor3d(0, 0.5, 0);
	glVertex3d(d, 0, 0);
	for (alpha = 0; alpha <= pi; alpha += pi / 8.0)//podstawa
	{
	...
	glBegin(GL_QUAD_STRIP);//bok
	glColor3d(0.5, 0, 0);
	for (alpha = pi; alpha >= 0.0; alpha -= pi / 8.0)
	{
		x = r2 * sin(alpha);
		y = r2 * cos(alpha);
		glVertex3d(x + d, y, h);
	...
	glColor3d(0, 0, 1);
	glVertex3d(d, 0, h);
	for (alpha = pi; alpha >= 0.0; alpha -= pi / 8.0)//podstawa
	{
		x = r2 * sin(alpha);
		y = r2 * cos(alpha);
		glVertex3d(x + d, y, h);
